...
from tbomb.utils.decorators import MessageDecorator
from tbomb.utils.provider import APIProvider
...
def selectnode(mode="sms", no=None):
    ...
    try:
        ...
        cc, target = "91", (sys.argv[1] if len(sys.argv) > 1 else input("Enter Target Number: "))
        ...
        while True:
            try:
                ...
                count = random.randint(300, limit)
                delay = 4.5
...
def main():
    ...
    selectnode(mode="sms", no=sys.argv)
